...
public class WechatTools {
	...
	public static String getUserNameByNickName(String nickName) {
		LOG.info("contactList:{}", core.getContactList());
		for (JSONObject o : core.getContactList()) {
			if (o.getString("NickName").equals(nickName)) {
				return o.getString("UserName");
			}
		}
		LOG.info("getUserNameByNickName return empty , nickName:{}", nickName);
		LOG.info("groupList:{}", core.getGroupList());
		return null;
	}
	...
	private static boolean webWxLogout() {
		...
		try {
			...
			LOG.info("webWxLogout text:{}",text);
			return true;
		} catch (Exception e) {
