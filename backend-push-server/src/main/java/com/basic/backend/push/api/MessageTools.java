package com.basic.backend.push.api;
...
public class MessageTools {
	...
	public static boolean sendMsgByNickName(String text, String nickName) {
		if (nickName != null) {
			...
			throw new RuntimeException(nickName+" 不存在!");
		}
		return false;
